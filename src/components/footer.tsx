...
const Github = () => (
    <a href="https://github.com/observerw" className="no-underline text-gray-100 hover:text-gray-300 dark:text-gray-500 dark:hover:text-gray-700 transition-colors duration-200">
